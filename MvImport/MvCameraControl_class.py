...
class MvCamera():
    ...
    # Add this method to the MvCamera class
    @staticmethod
    def MV_CC_SetNetAdapter(app_ip):
        """
        Bind the application to a specific network interface by IP address.
        :param app_ip: The IP address of the network interface to bind to.
        """
        MvCamCtrldll.MV_CC_SetNetAdapter.argtypes = [c_char_p]
        MvCamCtrldll.MV_CC_SetNetAdapter.restype = c_uint
        return MvCamCtrldll.MV_CC_SetNetAdapter(app_ip.encode('ascii'))